...
function Section10() {
  ...
  return (
    <div className='section section10'>
        <h2 data-aos="" data-aos-once='true'>Find the answers to all of our <br className='sec10-display-hidden'/> most frequently asked <br className='sec10-display-hidden'/>questions.</h2>
